...
export default function Example() {
  ...
  const { items, totalQuantity, subtotal, chnaged } = useSelector(
    (state) => state.cart
  );
                      ...
                      {items ? (
                        ...
                        <div className="flex flex-col justify-center items-center flex-grow">
                          ...
                          <Link
                            onClick={() => dispatch(toggleCartVisible())}
                            to={'/products-details'}
                            class="flex items-center mt-5 justify-center rounded-md border border-transparent bg-gray-700 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-gray-600"
                          >
                            Continue Shopping
                          </Link>
                        </div>
