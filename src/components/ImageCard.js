  ...
  return (
    <>
      <div class=" relative flex  flex-col justify-center overflow-hidden bg-gray-50">
        ...
        <div class="group relative m-0 flex h-72 w-96 rounded-xl shadow-xl sm:mx-auto sm:max-w-lg">
          <div class="z-10 w-full overflow-hidden rounded-xl  opacity-80 transition duration-300 ease-in-out group-hover:opacity-100 dark:opacity-70">
            <img
